...
| `crates/h2r-build`    | The extraction and build pipeline as a library. `extract` stages and compiles the program, its twelve libraries and the entry module with the plugin, and skips each one whose recorded input fingerprint still matches. `build_script` is what `crates/rshellcheck/build.rs` runs. It extracts that world, emits the entries as crates into `compiler/build/rshellcheck` and compiles them with Cargo's `RUSTC`, through `RUSTC_WRAPPER` when one is set. Emission and compilation are skipped while their fingerprints match. `h2r extract` is a CLI over the same code.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `crates/rshellcheck`  | ShellCheck's command line in Rust, built with clap over the compiled core. `entry/ShellCheckEntry.hs` defines the Haskell functions it calls. `cargo build --release` at the repository root builds it, extraction included, and needs GHC 9.6.7 and cabal.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
