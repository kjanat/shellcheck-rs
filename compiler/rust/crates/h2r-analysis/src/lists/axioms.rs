...
static AXIOMS: &[Axiom] = &[
    ...
    ax(
        ...
        true,
        Produces::Incremental,
        "the last inner list becomes the result's tail",
    ),
    ax(
    ...
    ax(
        ...
        true,
        Produces::Incremental,
        "splits on demand; each line's characters are forced to find the newline",
    ),
    ax(
    ...
    ax(
        ...
        true,
        Produces::Incremental,
        "at the list instance: the last inner list becomes the result's tail",
    ),
    ax(
